...
function getHandoffMessage(): string {
  ...
  // (เรื่องที่ 77) "ทีมงานกำลังดูแลท่านอยู่ค่ะ" ยืนยันว่ามีแอดมินเฝ้าหน้าจออยู่ตอนนี้จริง — เคสจริง:
  // ร้านบางวันเปิดบอทไว้ในช่วงเวลาทำการปกติแต่ไม่มีแอดมินเฝ้าจริง (เช่น วันหยุดพิเศษที่ยังเปิดบอทไว้)
  // ทำให้ลูกค้าคาดหวังว่ามีคนตอบอยู่ ทั้งที่ไม่มี — เปลี่ยนเป็นข้อความที่ไม่ยืนยันว่ามีคนเฝ้าอยู่ตอนนี้
  // แต่ยังให้ความมั่นใจว่าจะได้รับการติดต่อกลับเหมือนเดิม ใช้ได้ทั้งวันที่มีแอดมินจริงและวันที่ไม่มี
