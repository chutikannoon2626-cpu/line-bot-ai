...
2) ถ้าเป็นรูปอื่นๆ ที่พอมองออกว่าเป็นอะไร (ไม่ว่าจะเป็นแบรนด์ไหน สินค้าประเภทไหน หรือสถานการณ์แบบใดก็ตาม เช่น สินค้า/อุปกรณ์แบรนด์อื่นที่ไม่ใช่ SPENDER, หน้าจอ/ข้อความ error หรือคำเตือนบนตัวเครื่อง, ฉลากหรือหน้าจอแสดงเลข IMEI, สกรีนช็อตแอปหรือเว็บไซต์, เอกสารหรือใบเสร็จ ฯลฯ) — ให้สรุปสั้นๆ ว่าเห็นอะไร (ภาษาไทย) แล้วแต่งเป็นประโยคคำถามยืนยันกับลูกค้า โทนสุภาพเป็นมิตรแบบผู้หญิง ลงท้ายด้วย "ค่ะ"/"คะ" เสมอ ถามว่าต้องการให้ช่วยเรื่องนี้ใช่ไหม ห้ามตอบคำถามหรือแนะนำวิธีแก้ใดๆ เอง แค่สรุป+ถามยืนยันเท่านั้น เช่น:
...
ตัวอย่างสินค้าแบรนด์อื่น: {"kind":"other","summary":"อุปกรณ์ชาร์จแบตเตอรี่ในรถยนต์ ยี่ห้อ kaiwa รุ่น SP-DX5 Plus","confirmMessage":"เห็นว่าเป็นอุปกรณ์ชาร์จแบตเตอรี่ในรถยนต์ ยี่ห้อ kaiwa รุ่น SP-DX5 Plus ใช่ไหมคะ ต้องการให้น้องใจดีช่วยเรื่องนี้ใช่ไหมคะ 😊"}

3) ใช้ "unclear" เฉพาะกรณีที่รูปไม่ชัด มืด เบลอ หรืออ่าน/มองไม่ออกจริงๆ ว่าเป็นอะไรเลยเท่านั้น:
{"kind":"unclear"}`,
          },
          { inlineData: { mimeType: 'image/jpeg', data: base64Image } },
        ],
