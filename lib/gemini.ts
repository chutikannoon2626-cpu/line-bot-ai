...
D = ภาพ error บนหน้าจอ หรือความเสียหายทางกายภาพของตัวเครื่อง (เช่น เคสแตก ปุ่มหลุด สายชาร์จขาด ตัวเครื่องบุบ รอยร้าว) หรือปัญหาการใช้งานอื่นๆ
...
- D: สรุปอาการหรือความเสียหายที่เห็นให้แม่นยำครบถ้วน ไม่ว่าจะเป็น error บนหน้าจอหรือความเสียหายทางกายภาพของตัวเครื่อง
...
ลำดับความสำคัญเมื่อมีหลายรูปคนละประเภทปนกันในชุดเดียวกัน: E > G > A/C > D > B/F (ประเภทที่มาก่อนในลำดับนี้ตัดสินการตอบทั้งชุด — เช่นมี E ปนอยู่กับ F ให้ตอบ handoff ทันที ไม่ต้องพิจารณารูป F เลย)
...
4) ใช้ "unclear" เฉพาะกรณีที่รูปไม่ชัด มืด เบลอ หรืออ่าน/มองไม่ออกจริงๆ ว่าเป็นอะไรเลยเท่านั้น (ถ้ามีหลายรูป ต้องอ่านไม่ออกทุกรูปถึงจะใช้ unclear ได้ ถ้าอ่านออกบางรูปให้ใช้ข้อ 3 แทนแล้วบอกว่ารูปไหนอ่านไม่ออก):
{"kind":"unclear"}`,
          },
...
ลำดับความสำคัญเมื่อมีหลายรูปคนละประเภทปนกันในชุดเดียวกัน: E > G > A/C > D > B/F (ประเภทที่มาก่อนในลำดับนี้ตัดสินการตอบทั้งชุด)
...
4) ใช้ "unclear" เฉพาะกรณีที่ทั้งรูปและข้อความไม่ให้ข้อมูลอะไรเลยจริงๆ (รูปไม่ชัด/มืด/เบลอ ทุกรูป และข้อความก็ไม่มีความหมาย):
{"kind":"unclear"}`,
          },
          ...base64Images.map(img => ({ inlineData: { mimeType: 'image/jpeg', data: img } })),
        ],
